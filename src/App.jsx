  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/premium/:type" element={<PublicLayout><PremiumResults /></PublicLayout>} />
        <Route path="/search" element={<PublicLayout><SearchResults /></PublicLayout>} />
        <Route path="/video-search" element={<PublicLayout><VideoSearchResult /></PublicLayout>} />
        {/* Bonus Routes */}
        <Route path="/hub-spot-ai" element={<PublicLayout><HubSpot /></PublicLayout>} />
        <Route path='/gpt-list' element={<PublicLayout><GptGallery/></PublicLayout>}/>
