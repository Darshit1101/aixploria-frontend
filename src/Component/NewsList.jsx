...
import API_BASE_URL from "../Admin/utils/api"; // Make sure this points to http://localhost:5000 or your backend base
// import images and other components as needed
...
const NewAi = () => {
    ...
    const fetchNews = async () => {
        try {
            ...
            setNewsData(res.data); // Make sure your backend returns an array
        } catch (error) {
                ...
                <div className="h-[500px] overflow-y-auto custom-scrollbar pr-2">
                    {loading ? (
                        ...
                        newsData.map((item, idx) => (
                            <div
                                key={item._id || idx}
                                className="bg-[#191919] cursor-pointer border border-[#767676] flex items-center justify-between rounded-md px-4 py-3 mb-3 text-sm text-white hover:bg-[#333]"
                            >
