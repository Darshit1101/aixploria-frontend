...
const aiToolsData = [
  ...
  },
  {
    id:11,
    title:'AI Glossary',
    description:'Discover the meaning of terms related to artificial intelligence.',
    image:AIGlossary,
  },
  {
    id:12,
    title:'Live Events',
    description:'Watch live streams of the most important AI conferences and announcements.',
    image:Live,
  }
];

const AICard = ({ title, description, image, isNew }) => {
  return (
