...
export default function FeaturedCard({
  ...
  return (
    <div className="group relative w-full max-w-[300px] h-auto md:h-[275px] rounded-[30px] p-5 text-white bg-[#191919] opacity-[90%] overflow-hidden shadow-xl flex flex-col">
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-1 text-[16px] font-medium">
              ...
              <span className={free ? "text-[#11DF60] font-[700]" : "text-white"}>
                {free ? "Free" : "Featured"}
              </span>
            </div>
